	...
	SelectPage.prototype.setLanguage = function() {
		...
		case 'de':
            ...
            case 'fa':
                message = {
                    add_btn: 'افزودن دکمه',
                    add_title: 'افزودن یک باکس',
                    del_btn: 'دکمه حذف',
                    del_title: 'حذف یک باکس',
                    next: 'بعدی',
                    next_title: 'بعدی' + p.pageSize + ' (کلید Right)',
                    prev: 'قبلی',
                    prev_title: 'قبلی' + p.pageSize + ' (کلید Left)',
                    first_title: 'اولی (Shift + Left key)',
                    last_title: 'آخرین (Shift + Right key)',
                    get_all_btn: 'دریافت همه (Down key)',
                    get_all_alt: '(button)',
                    close_btn: 'بستن (کلید Tab)',
                    close_alt: '(button)',
                    loading: 'در حال بارگذاری...',
                    loading_alt: '(در حال بارگذاری)',
                    page_info: 'صفحه page_num از page_count',
                    select_ng: 'توجه : لطفا از لیست انتخاب کنید.',
                    select_ok: 'انتخاب موفقیت آمیز بود',
                    not_found: 'پیدا نشد',
                    ajax_error: 'هنگام اتصال به سرور خطایی رخ داد.',
                    clear: 'پاک کردن محتوا',
                    select_all: 'انتخاب همه',
                    unselect_all: 'عدم انتخاب همه',
                    clear_all: 'برداشتن همه انتخاب ها',
                    max_selected: 'شما فقط می توانید حداکثر تا max_selected_limit موارد را انتخاب کنید'
                };
                break;
		// English
		case 'en':
